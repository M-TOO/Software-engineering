...
// Define the dashboard files for redirection (Centralized in the function for flexibility)
// NOTE: We rely on the redirect_with_status helper function defined below.
...
function redirect_with_status($status, $message, $user_id = null, $role = null) {
    ...
    if ($status === 'success' && $user_id && $role) {
        ...
        $dashboard_files = [
            ...
            'Admin' => 'admin_dashboard.php', // MERGED: Admin routing added
        ];
...
$allowed_roles = [
    ...
    'garage_owner' => 'Garage', 
    'vendor' => 'Vendor',
    'admin' => 'Admin', // MERGED: Admin role added
];
...
if (isset($_POST['register_submit'])) {
    ...
    $is_business_role = ($role_schema === 'Garage' || $role_schema === 'Vendor'); // MERGED: Flag for business roles
